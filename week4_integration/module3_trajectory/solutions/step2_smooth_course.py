...
Build one smooth trajectory through a list of waypoints (a cubic spline) and fly it without
stopping -- a racing line -- by commanding velocity. Position is dead-reckoned, so it drifts.
"""
