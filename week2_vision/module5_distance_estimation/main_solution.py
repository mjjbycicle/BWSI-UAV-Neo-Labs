...
Week 2 · Module 5 — Distance Estimation (SOLUTION) — Main orchestrator

Runs every step in sequence against the simulator:
    drone sim module5_distance_estimation/main_test.py
...
neo_lab.run_module("Week 2 · Module 5 — Distance Estimation (SOLUTION)", [
